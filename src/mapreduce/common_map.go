...
func doMap(
	...
	if err != nil {
		log.Fatal("Do Map: ", err)
	}

	kvps := mapF(inFile, string(file))
	...
	for r := 0; r < nReduce; r++ {
		...
		if err != nil {
			log.Fatal("Reduce file create error: ", err)
		}
	}

	// write the list of key/value pair into reduce intermediate files
	for _, kvp := range kvps {
		r := ihash(kvp.Key) % nReduce
